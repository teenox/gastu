    ...
    <v-container>
      ...
      ----------------------------------------------- -->
        <v-col cols="12" sm="12" md="12" lg="3" class="px-xs-0">
          ...
          <p class="mt-10">Capital Park, 0084</p>
        </v-col>
        <!-- -----------------------------------------------
        Second Column
      ----------------------------------------------- -->
      ...
      ----------------------------------------------- -->
        <v-col cols="12" sm="12" md="12" lg="3" class="px-xs-0">
          ...
          <p class="mt-10 mb-0">
            Office : <a class="dark-link" href="/">info@gastu.co.za</a>
          </p>
          <p>
            Site :
            <a class="dark-link" href="https://gastu.co.za/"
              >gastu.co.za</a
            >
          </p>
        </v-col>
      ...
      <div class="footer-bottom-bar font-14">
        <div class="d-block d-md-flex align-center">
          <p>
            ...
            <a href="https://gastu.co.za" class="link">gastu.co.za</a>
          </p>
          <div class="ml-auto">
